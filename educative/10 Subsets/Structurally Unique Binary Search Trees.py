...
def findUnique_trees_recursive(start, end, memo):
    result = []
    ...
    for i in range(start, end + 1):
        ...
        leftSubtrees = findUnique_trees_recursive(start, i - 1, memo)
        rightSubtrees = findUnique_trees_recursive(i + 1, end, memo)
