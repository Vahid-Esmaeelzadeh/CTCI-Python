...
def main():
    ...
    print("Kth smallest number is: " +
          str(find_Kth_smallest2([[1, 4], [2, 5]], 2)))

    print("Kth smallest number is: " +
          str(find_Kth_smallest2([[-5]], 1)))

    print("Kth smallest number is: " +
          str(find_Kth_smallest2([[2, 6, 8], [3, 7, 10], [5, 8, 11]], 5)))

    print("Kth smallest number is: " +
          str(find_Kth_smallest2([[1, 5, 9], [10, 11, 13], [12, 13, 15]], 8)))
